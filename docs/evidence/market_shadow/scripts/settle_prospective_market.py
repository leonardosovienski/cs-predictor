"""Liquidação da coorte prospectiva: resultado oficial (Sports DB) -> Market DB.

Este era o elo que faltava. `ProspectiveStore.record_result`/`settle` existiam e
eram testados, mas nenhum entrypoint de produção os chamava: as cotações eram
coletadas, os eventos passavam do horário e paravam ali. Sem isto a coorte NUNCA
matura, por mais tempo que rode.
